...
def fetch_and_ingest_all_knowledge():
    """
    Ingests static company FAQs (What is BoiKiit, how it works) AND
    queries the 'books' table to ingest dynamic product metadata.
    """
    ...
    company_knowledge = [
        "BoiKiit (বইকিট) হলো বাচ্চাদের জন্য একটি কাস্টমাইজড বা পার্সোনালাইজড গল্পের বই তৈরির প্ল্যাটফর্ম।",
        "BoiKiit কীভাবে কাজ করে: অভিভাবকরা তাদের বাচ্চার নাম এবং পছন্দ অনুযায়ী থিম নির্বাচন করলে, এআই (AI) একটি সুন্দর গল্প ও ছবি তৈরি করে দেয়।এখানে বাচ্চারা স্টোরি বই পড়তে পারে।যেসব বাচ্চা পড়তে পারে নাহ তারাভয়েস এর মাধ্যমে বইয়ের গল্প শুনতে পারে।নিজেদের নামে বই বানাতে পারে।  এরপর চাইলে সেগুলা প্রিন্ট অর্ডার করতে পারে।",
    ...
    print("--- PART 3: Initializing Embedding Pipeline ---")

    # Initialize the 384-dimensional HuggingFace embedding model
